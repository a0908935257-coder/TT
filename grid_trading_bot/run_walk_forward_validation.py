...
def create_all_strategies() -> dict:
    ...
    rsi_config = RSIGridStrategyConfig(
        rsi_period=rsi.get("rsi_period", 7),
        rsi_block_threshold=rsi.get("rsi_block_threshold", 0.9),
        atr_period=rsi.get("atr_period", 7),
        grid_count=rsi.get("grid_count", 8),
        atr_multiplier=Decimal(str(rsi.get("atr_multiplier", "3.0"))),
        stop_loss_atr_mult=Decimal(str(rsi.get("stop_loss_atr_mult", "1.5"))),
        take_profit_grids=rsi.get("take_profit_grids", 2),
        max_hold_bars=rsi.get("max_hold_bars", 6),
        use_trailing_stop=rsi.get("use_trailing_stop", False),
        ...
        vol_atr_baseline_period=rsi.get("vol_atr_baseline_period", 200),
