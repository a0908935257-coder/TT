#!/usr/bin/env python3
"""
Compare Supertrend backtest results: Original vs Live-like strategy.
...
def run_backtest(klines: list[Kline], config: SupertrendStrategyConfig, name: str) -> dict:
...
async def main():
    """Main entry point."""
    print("="*80)
    print("Supertrend Strategy Comparison: Original vs Live-Like")
    print("="*80)
    ...
    original_config = SupertrendStrategyConfig(
    ...
    live_like_config = SupertrendStrategyConfig(
        mode=SupertrendMode.TREND_GRID,
        atr_period=14,
        atr_multiplier=Decimal("3.0"),
        grid_count=10,
